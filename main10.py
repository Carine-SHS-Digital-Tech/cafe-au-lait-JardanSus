        ...
        while nextItem:
            ...
            if order == "1":
                ...
                if choice == "2":
                    ...
                    item1_gst = prices[0] * qty * gst + prices[0] * qty * takeAway
            elif order == "2":
                qty = int(input("Enter Quantity: "))
                ...
                order_cups = order_cups + qty
                if choice == "2":
                    item1_gst = prices[1] * qty * gst
                else:
                    item1_gst = prices[1] * qty * gst + prices[1] * qty * takeAway
            elif order == "3":
                qty = int(input("Enter Quantity: "))
                ...
                order_cups = order_cups + qty
                if choice == "2":
                    item1_gst = prices[2] * qty * gst
                else:
                    item1_gst = prices[2] * qty * gst + prices[2] * qty * takeAway
            elif order == "4":
                qty = int(input("Enter Quantity: "))
                ...
                order_cups = order_cups + qty
                if choice == "2":
                    item1_gst = prices[3] * qty * gst
                else:
                    item1_gst = prices[3] * qty * gst + prices[3] * qty * takeAway
